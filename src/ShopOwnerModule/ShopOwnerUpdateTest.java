...
public class ShopOwnerUpdateTest {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("ownername")).sendKeys("Nazia Afrin");
		driver.findElement(By.name("password")).sendKeys("1234");
		
		driver.findElement(By.xpath("/html/body/form/div/div/div[2]/div/div[9]/button")).click();
		
		
		String at = driver.getCurrentUrl();
		
		String se = driver.findElement(By.name("service")).getText();
